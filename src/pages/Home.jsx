    ...
    <>
      <div className="col-span-3 md:col-span-2 flex flex-col justify-around p-5">
        ...
        <p className="text-xl leading-10 font-regular mb-6">
          ...
          have experience working on various management projects and am skilled
          in handling systems such as Linux and performing deployments. I am
          eager to pursue a full-stack web developer role, where I can apply my
